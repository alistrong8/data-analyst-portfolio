...
### **Sales Performance Dashboard** | *Excel, Python* | [Link to Project]
- Designed a dynamic Excel dashboard tracking **$1.2M+ in annual revenue** across multiple regions.
- Automated data ingestion from 3 distinct sources using **Power Query**, reducing reporting time by **40%**.
- Identified top-performing products, leading to a **15% optimization** in inventory allocation.

### **Customer Churn Analysis** | *SQL, Tableau* | [Link to Project]
- Analyzed 10,000+ customer records to identify key churn drivers using **SQL window functions**.
- Visualized findings in Tableau, highlighting a **high-risk segment** of month-to-month subscribers.
- Recommended retention strategies that could potentially reduce churn by **12%**.

### **Marketing Campaign ROI** | *SQL, Power BI* | [Link to Project]
- Evaluated performance of 5 digital marketing channels using **SQL**.
- Calculated ROAS and conversion rates, identifying **Facebook Ads** as the highest performing channel (3.5x ROAS).
